...
function addFileInputsHandlers() {
    let forms = document.querySelectorAll('form[data-role="form"]');
    console.log(forms);
    ...
    Array.from(forms).forEach(item => {
        form.addEventListener('change', (e) => {
            ...
            if (e.target.getAttribute('type') === 'file') {
                let fileLimit = item.getAttribute('data-limit');
                reloadFiles({
                    form: item,
                    target: e.target,
                    limit: fileLimit
...
// function reloadFiles({form, target, limit}) {
//      let rootInput = form.querySelector('input[type="file"]');
//      console.log(rootInput.files);

//      let rootInputId = rootInput.getAttribute('id');
//       let rootInputName = rootInput.getAttribute('name');

//      if(rootInput.files.length <= limit) {
//          let newInput = document.createElement('input');
//          newInput.setAttribute('type', 'file');
//          newInput.setAttribute('id', rootInputId);
//          newInput.setAttribute('name', rootInputName);
//          rootInput.after(newInput);
//      }
...
function reloadFiles(options) {
    ...
    // if (globalVars.inputFirst && globalVars.amountFiles <= options.limit - 1) {
    //     target.after(label);
    ...
    //     }
    // } else if (globalVars.labelFirst && globalVars.amountFiles <= options.limit - 1) {
    //     let newLabel = document.createElement('label');
    //     newLabel.setAttribute('for', newInputID);
    //     newLabel.innerHTML = startLabelText;
